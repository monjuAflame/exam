        ...
        <div class="row">
            <div class="col-md-8 mt-2">
                <form action="#" id="student-filter-form" method="POST">
                    <input type="hidden" name="dueFilter" id="" value="1">
                    <table>
                        <tr>
            ...
            <div class="col-md-4 mt-2">
                <div>
                    <a href="{{ route('student.create') }}" class='btn btn-primary btn-sm float-right'>Create Student</a>
                </div>
            </div>
        </div>
    </div>
