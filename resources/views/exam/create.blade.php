...
@section('content')
    <main class="content">
        <div class="container-fluid p-0">
            <h1 class="h3 mb-3">Create New Test</h1>

            <div class="row">

                <div class="col-12">
                    <form id="createTestForm" method="POST" action="{{ route('exam.store') }}">
                        @csrf
                        <div class="card">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-12 col-md-8">
                                        ...
                                        <input type="text" class="form-control" id="inputExamName"
                                               name="name" placeholder="Exam Name" autocomplete="off">
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-4">
                                        ...
                                        <input type="number" class="form-control" id="inputExamDuration"
                                               name="duration" placeholder="Enter exam duration"
                                               autocomplete="off">
                                    </div>
...
--}}
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="number" class="form-control" id="inputPassingScore"
                                               name="passing_score" placeholder="Enter minimum number to pass"
                                               autocomplete="off">
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea name="intro_text" class="form-control" id="inputExamDescription"
                                                  placeholder="Anything regarding the exam.." rows="3"></textarea>
                                    </div>
...
--}}
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea name="conclusion_text" type="text" class="form-control" id="inputConclusionMsg"
                                                  placeholder="Enter a test conclusion message" rows="3"></textarea>
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <textarea name="pass_message" type="text" class="form-control" id="inputPassMsg"
                                                  placeholder="Enter custom pass message" rows="3"></textarea>
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <textarea name="fail_message" type="text" class="form-control" id="inputFailMsg"
                                                  placeholder="Enter custom fail message" rows="3"></textarea>
                                    </div>
                        ...
                        <button type="submit" form="createTestForm" class="btn btn-primary">Create Test</button>
                    </form>
                </div>
            </div>
